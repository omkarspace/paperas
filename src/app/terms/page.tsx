    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary/95 to-primary/90 py-20 animate-gradient-shift">
          ...
          <div className="absolute top-10 left-[15%] w-24 h-24 rotate-12 border border-secondary/20 bg-secondary/5 animate-float-slow" />
          <div className="absolute bottom-10 right-[10%] w-28 h-28 rounded-full border border-secondary/15 bg-secondary/5 animate-float-medium" />
